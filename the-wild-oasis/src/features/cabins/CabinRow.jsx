        ...
        <>
            <TableRow role="row">
                ...
                <div>
                    ...
                    <button type="button" onClick={() => setShowForm(prevState => !prevState)}><HiPencil/></button>
                    <button type="button" onClick={() => deleteCabin(id)} disabled={isDeleting}><HiTrash/></button>
                </div>
            </TableRow>
